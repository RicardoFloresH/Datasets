...
## Tabular
- Iris: [Link](https://archive.ics.uci.edu/ml/datasets/iris)
- Cars: [Link](https://corgis-edu.github.io/corgis/csv/cars/)
- The Boston Housing Dataset: [Link](https://www.kaggle.com/code/prasadperera/the-boston-housing-dataset/data)
...
- Labeled Faces in the Wild: [Link](http://vis-www.cs.umass.edu/lfw/#explore)
- VisualQA: [Link](https://visualqa.org/)


## Text
- IMDB Reviews: [Link](http://ai.stanford.edu/~amaas/data/sentiment/)
